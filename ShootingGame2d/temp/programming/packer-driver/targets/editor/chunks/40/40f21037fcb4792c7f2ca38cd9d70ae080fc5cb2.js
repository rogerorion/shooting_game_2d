      ...
      _export("hero", hero = (_dec = ccclass('hero'), _dec(_class = class hero extends Component {
        ...
        update(deltaTime) {
          ...
          if (Inputs[KeyCode.KEY_D] == 1) {
            console.log("left");
            this.node.position.add(new Vec3(-speed * deltaTime, 0, 0));
          } else if (Inputs[KeyCode.KEY_A] == 1) {
            console.log("right");
            this.node.position.add(new Vec3(speed * deltaTime, 0, 0));
          } else if (Inputs[KeyCode.KEY_W] == 1) {
            console.log("up");
            this.node.position.add(new Vec3(0, speed * deltaTime, 0));
...
//# sourceMappingURL=40f21037fcb4792c7f2ca38cd9d70ae080fc5cb2.js.map