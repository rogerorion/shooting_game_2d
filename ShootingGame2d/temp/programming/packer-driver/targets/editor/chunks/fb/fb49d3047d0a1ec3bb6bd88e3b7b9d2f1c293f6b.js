System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, v2, TiledMap, RigidBody2D, ERigidBody2DType, BoxCollider2D, EPhysics2DDrawFlags, Contact2DType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, game;
    ...
    execute: function () {
      ...
      _export("game", game = (_dec = ccclass('game'), _dec2 = property(TiledMap), _dec(_class = (_class2 = class game extends Component {
          ...
          for (let i = 0; i < layerSize.width; i++) {
            for (let j = 0; j < layerSize.height; j++) {
              ...
              if (tiled.grid != 0) {
                ...
                collider.group = 2;
                collider.apply();
                collider.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, tiled.node);
              }
            }
          } // 注册单个碰撞体的回调函数
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          console.log('wall onBeginContact -- selfCollider.group = %d', selfCollider.group);
          console.log('wall onBeginContact -- otherCollider.group = %d', otherCollider.group);
        }
...
//# sourceMappingURL=fb49d3047d0a1ec3bb6bd88e3b7b9d2f1c293f6b.js.map