System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, macro, _dec, _class, _crd, ccclass, property, Inputs, hero;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("hero", hero = (_dec = ccclass('hero'), _dec(_class = class hero extends Component {
        onLoad() {
          this.node.on(Input.KEY_DOWN, this.onKeyDown, this);
...
//# sourceMappingURL=e6d829598eeeb8cc030fdcb6784938817e4db355.js.map