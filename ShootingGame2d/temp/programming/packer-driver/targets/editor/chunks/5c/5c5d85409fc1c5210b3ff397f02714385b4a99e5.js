      ...
      _export("hero", hero = (_dec = ccclass('hero'), _dec(_class = class hero extends Component {
        ...
        update(deltaTime) {
          ...
          if (Inputs[KeyCode.KEY_D] == 1) {
            ...
            this._lv.y = 0;
            this._lv.x = this._curPosition.x + this._speed * deltaTime;
            state = 1;
            ...
            this._lv.x = 0;
            this._lv.y = this._curPosition.y + this._speed * deltaTime;
            state = 1;
...
//# sourceMappingURL=5c5d85409fc1c5210b3ff397f02714385b4a99e5.js.map