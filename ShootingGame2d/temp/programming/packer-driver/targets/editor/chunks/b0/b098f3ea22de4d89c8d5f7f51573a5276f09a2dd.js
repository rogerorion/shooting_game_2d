System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, TiledMap, RigidBody2D, BoxCollider2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, game;
        ...
        start() {
          ...
          for (let i = 0; i < layerSize.width; i++) {
            for (let j = 0; j < layerSize.height; j++) {
              ...
              if (tiled.grid != 0) {
                let body = tiled.node.addComponent(RigidBody2D); // body.type = ERigidBody2DType.Static;
                // body.group = 1;
                // body.gravityScale = 1;

                let collider = tiled.node.addComponent(BoxCollider2D); // collider.offset = v2(tiledCellSize.width/2, tiledCellSize.height/2);
...
//# sourceMappingURL=b098f3ea22de4d89c8d5f7f51573a5276f09a2dd.js.map