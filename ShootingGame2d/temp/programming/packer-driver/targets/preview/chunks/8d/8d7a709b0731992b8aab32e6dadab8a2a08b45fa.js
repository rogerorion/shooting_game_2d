System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, TiledMap, RigidBody2D, ERigidBody2DType, BoxCollider2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, game;
          ...
          for (var i = 0; i < layerSize.width; i++) {
            for (var j = 0; j < layerSize.height; j++) {
              ...
              if (tiled.grid != 0) {
                ...
                var _collider = tiled.node.addComponent(BoxCollider2D); // collider.offset = v2(tiledCellSize.width/2, tiledCellSize.height/2);
...
//# sourceMappingURL=8d7a709b0731992b8aab32e6dadab8a2a08b45fa.js.map