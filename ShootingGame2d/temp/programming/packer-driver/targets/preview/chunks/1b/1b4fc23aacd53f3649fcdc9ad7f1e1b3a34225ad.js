          ...
          for (var i = 0; i < layerSize.width; i++) {
            for (var j = 0; j < layerSize.height; j++) {
              ...
              if (tiled.grid != 0) {
                ...
                body.group = 1;
                var collider = tiled.node.addComponent(BoxCollider2D); //collider.offset = v2(tiledCellSize.width/2, tiledCellSize.height/2);
...
//# sourceMappingURL=1b4fc23aacd53f3649fcdc9ad7f1e1b3a34225ad.js.map