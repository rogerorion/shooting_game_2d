System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, v2, TiledMap, RigidBody2D, ERigidBody2DType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, game;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'director', 'Node', 'PhysicsSystem2D', 'math', 'v2', 'TiledMap', 'RigidBody2D', 'ERigidBody2DType']);
          ...
          for (var i = 0; i < layerSize.width; i++) {
            for (var j = 0; j < layerSize.height; j++) {
              ...
              if (tiled.isValid) {
                ...
                body.group = 1;
                var collider = tiled.node.addComponent();
              }
            }
          }
        }
...
//# sourceMappingURL=325302a1e9686a72e6a05c15b1cd0512a532fd14.js.map